...
#
# The built zip also carries wfc_indicator.apk; customize.sh installs the
# indicator app (com.wfcind.app) and grants its runtime permissions during
# module install. This legacy hand-push path does NOT do that - install the
# apk manually (adb install -r wfc_indicator.apk) if you use hand-push.
